...
CAPTIONS = [
    ('Screenshot_20260511_094841_ESPEAK.jpg',
     'ИГРЫ',
     'Учи играя — не зубри',
     '8 мини-игр под твой испанский'),
    ('Screenshot_20260511_094848_ESPEAK.jpg',
     'СЛОВАРЬ',
     '5000 слов всегда\nпод рукой',
     'Озвучка · фразы · свои списки'),
...
def add_glass_banner(img: Image.Image, eyebrow: str,
    ...
    # 2. Dark vertical gradient tint — top a touch lighter than bottom
    tint = Image.new('RGBA', (banner_w, banner_h), (0, 0, 0, 0))
    tdraw = ImageDraw.Draw(tint)
    for y in range(banner_h):
        t = y / banner_h
        a = int(140 + 35 * t)            # 140 → 175
        tdraw.line([(0, y), (banner_w, y)], fill=(10, 12, 18, a))
    ...
    ImageDraw.Draw(sheen).rounded_rectangle(
        [0, 0, banner_w, int(banner_h * 0.42)],
        radius=radius, fill=(255, 255, 255, 20))
    ...
    ImageDraw.Draw(border).rounded_rectangle(
        ...
        radius=radius, outline=(255, 255, 255, 95), width=2)
