...
# Compose — Casa Batlló left, Sagrada centre (HERO), Casa Milà,
# Giralda — all in the visible left+centre band, away from phone.
casa_batllo(20, scale=0.95)
sagrada_familia(180, scale=0.95)        # HERO
casa_mila(400, scale=0.85)
giralda(540, scale=0.95)
