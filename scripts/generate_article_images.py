...
PROMPT_TEMPLATE = (
    "vibrant modern photograph of a single {subject}, "
    "isolated against a soft warm pastel background with subtle gradient "
    "(pale cream, light peach or soft mint), "
    "gentle natural shadow grounding the subject, "
    "bright cheerful even lighting, rich saturated natural colors, "
    "sharp clear focus, full subject visible centered in frame, "
    "no landscape, no sky, no ground texture, no environment, "
    "no people, no other objects, no text, no studio details, "
    "photorealistic, friendly modern style suitable for both adults and children, "
    "high-quality language-learning-app imagery in the spirit of Duolingo or Babbel"
)
