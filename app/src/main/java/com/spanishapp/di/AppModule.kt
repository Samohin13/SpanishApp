...
object AppModule {
    ...
    fun provideDatabase(@ApplicationContext context: Context): AppDatabase {
        val builder = Room.databaseBuilder(context, AppDatabase::class.java, "spanish_app.db")
            // v1.26.1: единый список — см. AppDatabase.ALL_MIGRATIONS.
    ...
    @Provides fun provideWeakVerbDao(db: AppDatabase): com.spanishapp.data.db.dao.WeakVerbDao = db.weakVerbDao()
